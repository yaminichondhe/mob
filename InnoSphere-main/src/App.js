...
import img17 from './images/appointment-booking-calendar-design.png';
import img18 from './images/noteshare.png';
  ...
  return (
   ...
   <div className='gradient-background'>
    ...
    <div className='f1'>
        ...
        <div className='att'>
        <img src={img17} style={{  width: "100%", height: "90%"}} alt="Responsive image" />
        </div>
